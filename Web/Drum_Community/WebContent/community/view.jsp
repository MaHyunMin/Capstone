...
<%
	...
	try {
		...
		String sql = "SELECT USERNAME, TITLE, MEMO, d_TIME, HIT FROM boardinfo WHERE NUM=" + idx;
...
<%
			sql = "UPDATE boardinfo SET HIT=" + hit + " where NUM=" +idx;
...
%>	
						...
						<input type=button value="목록" OnClick = "window.location = 'post.jsp'">
