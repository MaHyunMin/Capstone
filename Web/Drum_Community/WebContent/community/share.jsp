			...
			<div class="board" style="width: 50%; margin: 0 25%; position: absoulte; align: center;">
				<%
					...
					try {
						...
						String sqlCount = "SELECT COUNT(*) FROM boardinfo2";
						...
						String sqlList = "SELECT NUM, USERNAME, TITLE, d_TIME, HIT from boardinfo2 order by NUM DESC";
				...
				<tr height="25" align="center">
					<td>&nbsp;</td>
					<td><%=idx %></td>
					<td align="left"><a href="share_view.jsp?idx=<%=idx%>"><%=title %></td>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
				  ...
				  <tr align="center">
				   <td><input type=button value="글쓰기" OnClick = "window.location='share_write.jsp'"></td>
				  </tr>
				</table>			
			</div>
		<div class="footer">
